...
import DigitalCard from "./components/global/DigitalCard";
import "./index.css";
...
const App = () => {
  const id = "64be960ec127adef2952639a";
  ...
  return isLoading ? (
    ...
    <div className="App">
      <GlobalDataContext.Provider value={{ rpdata }}>
        <Routes>
          {/* Rutas comunes para todas las vistas */}
          <Route exact path="/" element={<Home />} />
          <Route path="*" element={<ErrorPages />} />

          {/* Condicional para mostrar o no ciertas rutas */}
